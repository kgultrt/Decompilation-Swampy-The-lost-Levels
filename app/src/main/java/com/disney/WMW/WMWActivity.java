...
public class WMWActivity extends BaseActivity {
    ...
    public WMWActivity() {
        ...
        this.mContext = this;
        this._activityPackageName = "com.decompilationpixel.WMW";
    }
    ...
    public void captureScreen() {
        ...
        Toast.makeText(this,"did capture",0).show();
        ...
        if (this._view != null) {
            ...
            if (this.hasFocus || this.hasWindowFocus() && this.isRunning) {
                ...
                if (this.gamePaused) {
                    ...
                    Toast.makeText(this,"Audio started!",0).show();
                }
            } else {
    ...
    public void onWindowFocusChanged(boolean var1) {
        ...
        Toast.makeText(this,"focus change: " + var1,0).show();
        if (var1) {
            this.hideSystemUI();
        }
        ...
        if (this._view != null) {
            if (var1 && this.isRunning && this.gamePaused) {
                ...
                Toast.makeText(this,"focus regained",0).show();
    ...
    public void openURL(String var1) {
        ...
        try {
            ...
            //Toast.makeText(this,"failed to launch url",0).show();
